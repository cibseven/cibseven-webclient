...
public class DeploymentProviderIT extends BaseHelper {
    ...
    void testDeleteDeployment() throws Exception {
        ...
        assertThat(request.getRequestUrl().encodedPath()).isEqualTo("/engine-rest/deployment/deployment-1");
        assertThat(request.getRequestUrl().queryParameter("cascade")).isEqualTo("true");
    }
}
