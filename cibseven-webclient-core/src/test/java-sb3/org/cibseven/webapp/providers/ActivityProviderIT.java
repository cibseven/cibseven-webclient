...
public class ActivityProviderIT extends BaseHelper {
    ...
    void testFindActivityInstance() throws Exception {
        ...
        assertThat(request.getRequestUrl().encodedPath()).isEqualTo("/engine-rest/process-instance/12345/activity-instances");
    }
    ...
    void testFindActivitiesInstancesHistory() throws Exception {
        ...
        var request = mockWebServer.takeRequest();
        assertThat(request.getMethod()).isEqualTo("GET");
        assertThat(request.getRequestUrl().encodedPath()).isEqualTo("/engine-rest/history/activity-instance");
        assertThat(request.getRequestUrl().queryParameter("processInstanceId")).isEqualTo("12345");
    }
    ...
    void testDeleteVariableByExecutionId() throws Exception {
        ...
        assertThat(request.getRequestUrl().encodedPath()).isEqualTo("/engine-rest/execution/execution-123/localVariables/variable-1");
    }
    ...
    void testDeleteVariableHistoryInstance() throws Exception {
        ...
        var request = mockWebServer.takeRequest();
        assertThat(request.getMethod()).isEqualTo("DELETE");
        assertThat(request.getRequestUrl().encodedPath()).isEqualTo("/engine-rest/history/variable-instance/variable-history-123");
    }
