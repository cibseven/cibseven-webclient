...
/**
 * Authentication service for standalone modeler mode.
 * This service is disabled when modeler is integrated with webclient,
 * as webclient provides its own authentication handling.
 */
@ApiResponses({ @ApiResponse(responseCode = "500", description = "An unexpected system error occured") })
@ConditionalOnProperty(
	prefix = "cibseven.modeler.auth",
	name = "enabled",
	havingValue = "true",
