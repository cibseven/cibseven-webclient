...
/**
 * Provider implementation for external tasks operations using Camunda REST API
 */
@Slf4j
@Component
public class ExternalTaskProvider extends SevenProviderBase implements IExternalTaskProvider {
