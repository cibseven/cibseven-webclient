...
public interface ISystemProvider {
	...
	default Collection<Metric> getAnnualMetricsForYear(Map<String, Object> queryParams, CIBUser user, int year) {
		Collection<Metric> metrics = new ArrayList<>();
	...
	default Collection<Metric> getMonthlyMetrics(Map<String, Object> queryParams, CIBUser user) {
		Collection<Metric> metrics = new ArrayList<>();
		List<String> metricNames = Optional.ofNullable(queryParams.get("metrics"))
			.map(Object::toString)
			.filter(s -> !s.isEmpty())
