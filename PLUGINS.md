...
| `process-definition-tab` | one tab of a process definition, beside *Instances* and *Incidents* | `process`, `tenantId` |
| `decision-definition-tab` | one tab of a decision definition version | `decision`, `tenantId` |
| `decision-instance-tab` | one tab of a decision instance, beside *Inputs* and *Outputs* | `instance`, `decision`, `tenantId` |
