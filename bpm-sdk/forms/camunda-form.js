...
import InputFieldHandler from './controls/input-field-handler.js';

import ChoicesFieldHandler from './controls/choices-field-handler.js';

import FileDownloadHandler from './controls/file-download-handler.js';

import ErrorButtonHandler from './controls/error-button-handler.js';

import EscalationButtonHandler from './controls/escalation-button-handler.js';
...
CamundaForm.prototype.executeFormScript = function(script) {
  /* jshint evil: true */
  // Wrap the script in a function that takes camForm as an argument
  var fn = new Function('camForm', '$', script);
  fn(this, $);
  /* jshint evil: false */
};
