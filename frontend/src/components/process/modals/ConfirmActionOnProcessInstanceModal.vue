...
<template>
  <ConfirmDialog v-if="params" ref="confirm"
    @ok="params.ok(params.instance)"
    :ok-title="params?.okTitle">
    ...
    <p>
      ...
      <strong :title="formatDateForTooltips(params?.instance?.startTime)">{{ formatDate(params?.instance?.startTime) }}</strong>
