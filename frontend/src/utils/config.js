  ...
  admin: {
    resourcesTypes: {
      ...
      "13": { "id": "13", "key": "batch", "permissions": [
        "READ","CREATE","DELETE","READ_HISTORY","DELETE_HISTORY","CREATE_BATCH_MIGRATE_PROCESS_INSTANCES",
        ...
        "CREATE_BATCH_UPDATE_PROCESS_INSTANCES_SUSPEND","CREATE_BATCH_SET_VARIABLES","CREATE_BATCH_DELETE_DEPLOYMENTS","CREATE_BATCH_CORRELATE_MESSAGE"
      ] },
