...
a};b.CibIwcMaster.prototype.getMessageHandler=function(){return this._msgHandler};b.CibIwcMaster.prototype.callFunction=function(a,c,e){this._msgHandler.call(a,c,e)};b.CibIwcMaster.prototype.registerFunction=function(a,c,e){this._msgHandler.registerFunction(a,c,e)};b.CibIwcMaster.prototype.openURLInFrame=function(a,c){var e;if(e="string"===typeof a?document.querySelector(a):void 0!==window.jQuery&&a instanceof jQuery?a[0]:a){var b=this;e.addEventListener("load",function(a){b._onLoad(a.target.contentWindow,
"iframe")});e.setAttribute("src",c);e.setAttribute("_cid",this._cId);this._domElement=e;this._type="iframe";e=e.contentWindow;"undefined"!==typeof e&&this._onLoad(e,this._type)}};b.CibIwcMaster.prototype.lookupWindow=function(){if(!this._win){var a=this._domElement?this._domElement.contentWindow:null;a&&this._onLoad(a,this._type)}return this._win};b.CibIwcMaster.prototype.openURLInNewWindow=function(a){this._win&&!0!=this._win.closed?(window.console&&window.console.debug&&window.console.debug("Window already open, focusing "+
this._win),this._win.focus()):this._isLoaded||(a=window.open(a),this._onLoad(a,"externalWindow"))};b.CibIwcMaster.prototype._onLoad=function(a,c){if(!this._isLoaded){this._isLoaded=!0;this._win=a;this._type=c;var b=this.getMessageHandler();b.setWindow(this._win);b.init()}};b.CibIwcMaster.prototype.hasPendingServiceCall=function(a){return this._msgHandler.hasPendingServiceCall(a)};b.CibIwcMaster.prototype.sendServiceCallSuccess=function(a,c){this._msgHandler.sendServiceCallSuccess(a,c)};b.CibIwcMaster.prototype.sendServiceCallError=
...
(function(b){b.CibIwcMasterController=function(a){this._clients=[];this._msgHandler=new b.CibIwcMessaging("cib.iwc.technicalcall");this._slave=this._slaveInitCallback=this._masterLoadCallback=null;this._urlParams={};this._defaultIWCMode=a;var c=this;(window.onpopstate=function(){var a,b=/\+/g,f=/([^&=]+)=?([^&]*)/g,h=window.location.search.substring(1);for(c.urlParams={};a=f.exec(h);)c._urlParams[decodeURIComponent(a[1].replace(b," "))]=decodeURIComponent(a[2].replace(b," "))})()};b.CibIwcMasterController.prototype.getMode=
function(){return"string"===typeof this._urlParams.iwc_mode?this._urlParams.iwc_mode:this._defaultIWCMode};b.CibIwcMasterController.prototype._createClientId=function(){return function(){function a(a){var b=(Math.random().toString(16)+"000000000").substr(2,8);return a?"-"+b.substr(0,4)+"-"+b.substr(4,4):b}return a()+a(!0)+a(!0)+a()}()};b.CibIwcMasterController.prototype._msgIdRequest=function(a,c){window.console&&window.console.debug&&window.console.debug("handling client request",a,c);for(var b=
c.source,d=0;d<this._clients.length;++d){var f=this._clients[d],h=f.lookupWindow();null!=h&&"undefined"!==typeof h||this._log("Window of "+f._cId+" not yet initialized.");if(h==b){this._log("Got id request from window of "+f._cId+" "+JSON.stringify(a));if("function"===typeof f.onClientConnected)f.onClientConnected(a);else f._clientInfo=a;return{clientId:f._cId,channel:f._channel,CIB_iwc_version:"0.1"}}}throw"Source window not recognized, was the Slave created by this master?";};b.CibIwcMasterController.prototype.disconnectMaster=
...
function(a){return this._clients};b.CibIwcMasterController.prototype.createMaster=function(){var a=this._createClientId(),a=new b.CibIwcMaster(a);this._onClientLoad(a);this._clients.push(a);return a};b.CibIwcMasterController.prototype._onClientLoad=function(a){if(this._slave){var c=this;a.getMessageHandler().setFunctionNotFoundHandler(function(b,d,f,h){c._onFunctionNotFound(a,b,d,f,h);window.console&&window.console.debug&&window.console.debug("Handling not found function: ",arguments)})}this._masterLoadCallback&&
...
0;c<this._delegatedFunctions.length;++c){var b=this._delegatedFunctions[c];this._delegateSlaveClientFunc(b.name,b.async,b.callback)}};this._delegateSlaveClientFunc=function(a,b,d){var f=this;this._slave.registerFunction(a,function(b,e){f._callCallback(d,b,e);f._callClient(a,b)},b)};this._callClient=function(b,e){try{a.console&&a.console.debug&&a.console.debug("Calling Function Slave-\x3eClient ",b,e),this._client.callFunction(b,e,{success:function(f){a.console&&a.console.debug&&a.console.debug("Success Slave-\x3eClient ",
b,f);return f},failure:function(f){a.console&&a.console.debug&&a.console.debug("failure Slave-\x3eClient",b,e);throw f;}})}catch(d){a.console&&a.console.error&&a.console.error("Delegation failed ",d)}};this._delegateClientSlave=function(){a.console&&a.console.debug&&a.console.debug("Register delegated functions Client-\x3eSlave ");for(var b=0;b<this._delegatedFunctions.length;++b){var e=this._delegatedFunctions[b];this._delegateClientSlaveFuncAsync(e.name,e.callback)}};this._delegateClientSlaveFunc=
function(b,e){var d=this._slave;this._client.registerFunction(b,function(f,e){a.console&&a.console.debug&&a.console.debug("Calling Nonasync Function Client-\x3eSlave ",b);d.callFunction(b,f,{success:function(f){a.console&&a.console.debug&&a.console.debug("Nonasync Success Client-\x3eSlave",b,f);return f},failure:function(d){a.console&&a.console.debug&&a.console.debug("Nonasync  Outerfailure Client-\x3eSlave",b,f);throw d;}})},!1)};this._delegateClientSlaveFuncAsync=function(a,b){var d=this;this._client.registerFunction(a,
function(f,h,p){d._callCallbackAsync(b,f,h,p);d._callSlaveAsync(b,a,f,h,p)},!0)};this._callCallbackAsync=function(b,e,d,f){try{b&&b.success&&b.success(d)}catch(h){a.console&&a.console.error&&a.console.error("Callback Async call failed",h)}};this._callCallback=function(b,e,d){try{b&&b.success&&b.success(e)}catch(f){a.console&&a.console.error&&a.console.error("Callback call failed",f)}};this._callSlaveAsync=function(b,e,d,f,h){try{a.console&&a.console.debug&&a.console.debug("Calling Async Function Client-\x3eSlave ",
e);var p=this._client,g=this;this._slave.callFunction(e,f,{success:function(f){g._callCallback(b,f,h);a.console&&a.console.debug&&a.console.debug("Async Success Client-\x3eSlave",e,f);p._msgHandler.sendServiceCallSuccess(d,f)},failure:function(b){a.console&&a.console.debug&&a.console.debug("Async Failure Client-\x3eSlave",e,f);p._msgHandler.sendServiceCallFailure(d,f)}})}catch(k){a.console&&a.console.error&&a.console.error("Delegation failed",k)}}};b.CibIwcMasterBroadcastDelegator=function(b){this._master=
...
function(b,c,f){var h=this;this._slave.registerFunction(b,function(c,d){try{h._callCallback(f,c,d),h._callClients(b,c)}catch(k){a.console&&a.console.error&&a.console.error("Delgation failed",k)}},c)};this._callClients=function(b,c){for(var f=this._master.listMasters(),h=0;h<f.length;++h)try{this._callClient(f[h],b,c)}catch(p){a.console.error("Client #"+h+" couldnt be called.",p)}};this._callClient=function(b,c,f){try{a.console&&a.console.debug&&a.console.debug("Calling Function Slave-\x3eClient ",
c,f),b.callFunction(c,f,{success:function(b){a.console&&a.console.debug&&a.console.debug("Success Slave-\x3eClient ",c,b);return b},failure:function(b){a.console&&a.console.debug&&a.console.debug("failure Slave-\x3eClient",c,f);throw b;}})}catch(h){a.console&&a.console.error&&a.console.error("Delegation failed ",h)}};this._callCallback=function(b,c,f){try{b&&b.success&&b.success(c)}catch(h){a.console&&a.console.error&&a.console.error("Callback call failed",h)}}}})(window,window);
...
(function(b,a,c){if(!("console"in b)){var e=b.console={};e.log=e.warn=e.error=e.debug=function(){}}a===NO_JQUERY&&(a={fn:{},extend:function(){for(var a=arguments[0],b=1,c=arguments.length;b<c;b++){var d=arguments[b],e;for(e in d)a[e]=d[e]}return a}});a.pm=function(){b.console.log("usage: \nto send:    wrapper.pm(options)\nto receive: wrapper.pm.bind(type, fn, [origin])");return this};a.pm=b.pm=function(a){d.send(a)};a.pm.bind=b.pm.bind=function(a,b,c,e,k){d.bind(a,b,c,e,!0===k)};a.pm.unbind=b.pm.unbind=
function(a,b){d.unbind(a,b)};a.pm.origin=b.pm.origin=null;a.pm.poll=b.pm.poll=200;var d={send:function(c){try{var e=a.extend({},d.defaults,c),p=e.target;if(e.target)if(e.type){var g={data:e.data,type:e.type};e.success&&(g.callback=d._callback(e.success));e.error&&(g.errback=d._callback(e.error));if("postMessage"in p&&!e.hash){d._bind();try{p.postMessage(JSON.stringify(g),e.origin||"*")}catch(k){throw b.console&&b.console.error&&b.console.error("postmessage failed",k),k;}}else d.hash._bind(),d.hash.send(e,
g)}else b.console.warn("postmessage type required",c);else b.console.warn("postmessage target window required",c)}catch(n){throw b.console&&b.console.info&&b.console.error("postmessage send error",n),n;}},bind:function(a,b,c,e,k){d._replyBind(a,b,c,e,k)},_replyBind:function(c,e,p,g,k){"postMessage"in b&&!g?d._bind():d.hash._bind();g=d.data("listeners.postmessage");g||(g={},d.data("listeners.postmessage",g));var n=g[c];n||(n=[],g[c]=n);n.push({fn:e,callback:k,origin:p||a.pm.origin})},unbind:function(a,
b){var c=d.data("listeners.postmessage");if(c)if(a)if(b){var e=c[a];if(e){for(var k=[],n=0,r=e.length;n<r;n++){var l=e[n];l.fn!==b&&k.push(l)}c[a]=k}}else delete c[a];else for(n in c)delete c[n]},data:function(a,b){return b===c?d._data[a]:d._data[a]=b},_data:{},_CHARS:"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split(""),_random:function(){for(var a=[],b=0;32>b;b++)a[b]=d._CHARS[0|32*Math.random()];return a.join("")},_callback:function(a){var b=d.data("callbacks.postmessage");
b||(b={},d.data("callbacks.postmessage",b));var c=d._random();b[c]=a;return c},_bind:function(){d.data("listening.postmessage")||(b.addEventListener?b.addEventListener("message",d._dispatch,!1):b.attachEvent&&b.attachEvent("onmessage",d._dispatch),d.data("listening.postmessage",1))},_dispatch:function(a){try{var c={};try{c=JSON.parse(a.data)}catch(e){a.data.source&&"vue-devtools-backend"===a.data.source||b.console&&b.console.info&&b.console.warn("postmessage data invalid json: ",a,e);return}if(c.type){var g=
(d.data("callbacks.postmessage")||{})[c.type];if(g)g(c.data);else for(var k=(d.data("listeners.postmessage")||{})[c.type]||[],g=0,n=k.length;g<n;g++){var r=k[g];if(r.origin&&"*"!==r.origin&&a.origin!==r.origin)b.console.warn("postmessage message origin mismatch",a.origin,r.origin),c.errback&&d.send({target:a.source,data:{message:"postmessage origin mismatch",origin:[a.origin,r.origin]},type:c.errback});else{var l=function(b,e){c.callback&&d.send({target:a.source,data:b,type:e?c.errback:c.callback})};
try{r.callback?r.fn(c.data,l,a):l(r.fn(c.data,a),!1)}catch(m){if(m.stack&&(b.console&&b.console.error(m.stack),m=m.message),c.errback)l(m,!0);else throw m;}}}}else b.console&&b.console.info&&b.console.warn("postmessage message type required")}catch(t){throw t;}},hash:{send:function(a,c){var e=a.target,g=a.url;if(g){var g=d.hash._url(g),k,n=d.hash._url(b.location.href);if(b==e.parent)k="parent";else try{for(var r=b.parent,l=0,m=r.frames.length;l<m;l++)if(r.frames[l]==b){k=l;break}}catch(t){k=b.name}null==
k?b.console.warn("postmessage windows must be direct parent/child windows and the child must be available through the parent window.frames list"):(k={"x-requested-with":"postmessage",source:{name:k,url:n},postmessage:c},n="#x-postmessage-id\x3d"+d._random(),e.location=g+n+encodeURIComponent(JSON.stringify(k)))}else b.console.warn("postmessage target window url is required")},_regex:/^\#x\-postmessage\-id\=(\w{32})/,_regex_len:50,_bind:function(){d.data("polling.postmessage")||(setInterval(function(){var a=
""+b.location.hash,c=d.hash._regex.exec(a);c&&(c=c[1],d.hash._last!==c&&(d.hash._last=c,d.hash._dispatch(a.substring(d.hash._regex_len))))},a.pm.poll||200),d.data("polling.postmessage",1))},_dispatch:function(a){if(a){try{if(a=JSON.parse(decodeURIComponent(a)),!("postmessage"===a["x-requested-with"]&&a.source&&null!=a.source.name&&a.source.url&&a.postmessage))return}catch(c){return}var e=a.postmessage,g=(d.data("callbacks.postmessage")||{})[e.type];if(g)g(e.data);else{var k;k="parent"===a.source.name?
b.parent:b.frames[a.source.name];for(var g=(d.data("listeners.postmessage")||{})[e.type]||[],n=0,r=g.length;n<r;n++){var l=g[n];if(l.origin){var m=/https?\:\/\/[^\/]*/.exec(a.source.url)[0];if("*"!==l.origin&&m!==l.origin){b.console.warn("postmessage message origin mismatch",m,l.origin);e.errback&&d.send({target:k,data:{message:"postmessage origin mismatch",origin:[m,l.origin]},type:e.errback,hash:!0,url:a.source.url});continue}}m=function(b){e.callback&&d.send({target:k,data:b,type:e.callback,hash:!0,
url:a.source.url})};try{l.callback?l.fn(e.data,m):m(l.fn(e.data))}catch(t){if(e.errback)d.send({target:k,data:t,type:e.errback,hash:!0,url:a.source.url});else throw t;}}}}},_url:function(a){return(""+a).replace(/#.*$/,"")}}};a.extend(d,{defaults:{target:null,url:null,type:null,data:null,success:null,error:null,origin:"*",hash:!1}})})(this,"undefined"===typeof jQuery?NO_JQUERY:jQuery);"JSON"in window&&window.JSON||(JSON={});
(function(){function b(a){return 10>a?"0"+a:a}function a(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=p[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function c(b,e){var d,l,m,p,u=f,s,q=e[b];q&&"object"===typeof q&&"function"===typeof q.toJSON&&(q=q.toJSON(b));"function"===typeof g&&(q=g.call(e,b,q));switch(typeof q){case "string":return a(q);case "number":return isFinite(q)?String(q):"null";case "boolean":case "null":return String(q);
case "object":if(!q)return"null";f+=h;s=[];if("[object Array]"===Object.prototype.toString.apply(q)){p=q.length;for(d=0;d<p;d+=1)s[d]=c(d,q)||"null";m=0===s.length?"[]":f?"[\n"+f+s.join(",\n"+f)+"\n"+u+"]":"["+s.join(",")+"]";f=u;return m}if(g&&"object"===typeof g)for(p=g.length,d=0;d<p;d+=1)l=g[d],"string"===typeof l&&(m=c(l,q))&&s.push(a(l)+(f?": ":":")+m);else for(l in q)Object.hasOwnProperty.call(q,l)&&(m=c(l,q))&&s.push(a(l)+(f?": ":":")+m);m=0===s.length?"{}":f?"{\n"+f+s.join(",\n"+f)+"\n"+
u+"}":"{"+s.join(",")+"}";f=u;return m}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(a){return this.getUTCFullYear()+"-"+b(this.getUTCMonth()+1)+"-"+b(this.getUTCDate())+"T"+b(this.getUTCHours())+":"+b(this.getUTCMinutes())+":"+b(this.getUTCSeconds())+"Z"},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()});var e=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
